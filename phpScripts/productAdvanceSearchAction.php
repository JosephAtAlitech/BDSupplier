...
{
    $id = $_POST['id'];
    $sql = "SELECT tbl_currentStock.currentStock, tbl_warehouse.wareHouseName, tbl_warehouse.id,tbl_products.type 
    ...
    while ($row = $result->fetch_array()) {
         ...
         if($row['currentStock'] > 0){
            ...
            $output .= '<a href="#" class="advanceButton" onclick="selectProducts('.$id.','.$row['id'].','.$productType.')"><i class="fa fa-plus"></i></a>';
         }
         $output .= '</td></tr></table>';    
