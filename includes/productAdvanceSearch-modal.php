...
<script>
	...
	$(document).ready(function() {
		var salesTypeCheck = $('.sales-type-check').data('sales-type');
		$("#hitPageName").val(salesTypeCheck);
	});
	...
	function selectProducts(productId, warehouse_id, productType) {
		if (productType == "serialize") {
			let hitpage = $("#hitPageName").val();
			if (hitpage =! "damageProducts" || hitpage != "wareHouseTransfer") {
				showSerializTable(productId, warehouse_id, '', productId)
				return '';
			}
		}
