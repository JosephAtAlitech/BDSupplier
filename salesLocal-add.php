						...
						<div class="row"><br>
							<div class="col-md-12">
								<div class="input-group">
                                    ...
                                    <a href="#" onclick="advanceSearch('walkinSales')" class="input-group-addon sales-type-check" data-sales-type="partySale" style="background-color:#e1e1e1;color:#060afd;border-radius: 0px 8px 8px 0px;box-shadow: -5px 0px 0px 0px #e1e1e1;"><i class="fa fa-search"></i></a>
                                </div>
							</div>
